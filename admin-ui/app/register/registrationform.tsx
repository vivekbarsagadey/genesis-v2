              ...
              >
                <Grid item xs={12}>
                  ...
                  <InputBase
                    ...
                    placeholder="User Name" className={classes.textfield}/>
                  {errors.name && (
                ...
                <Grid item xs={12} mt={-2}>
                  ...
                  <InputBase
                    {...register("phone")} type="text"  placeholder="Phone"
                     className={classes.textfield} />
                  {errors.phone && (
                    <p className={classes.errormessage}>
                ...
                <Grid item xs={12} mt={-2}>
                  <Grid container spacing={2}>
                    <Grid item xs={6}>
                      ...
                      <InputBase {...register("password")} type={isPassword ? "password" : "text"}
                        placeholder="Password" className={classes.textfield}
                        endAdornment={
                        ...
                        onChange={openPassword} value={showPassword}
                      />
                      {errors.password && (
                        <p className={classes.errormessage}>
                    ...
                    <Grid item xs={6}>
                      ...
                      <InputBase
                        {...register("confirmpassword")} type={isCfrmPassword ? "password" : "text"}
                        placeholder="Confirm Password" className={classes.textfield}
                        endAdornment={
                          <InputAdornment position="end">
