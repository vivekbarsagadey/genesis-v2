...
import {
	Box, Checkbox, Grid, IconButton, Pagination, Paper, Typography,
} from '@mui/material';
...
function ListViewComponent({ widgets }: WidgetsHomeComponentsProps) {
  ...
  >
							...
							{querySort ? (
								<IconButton onClick={() => handleQuerySort()}>
									<ArrowDropUpIcon />
  </IconButton>
							) : (
								<IconButton onClick={() => handleQuerySort()}>
  ...
  >
			...
			<Grid container mt={4}>
				<Grid item xs={12} display="flex" justifyContent="flex-end">
					...
					<Pagination
						count={count} size="small" page={page} color="primary"
